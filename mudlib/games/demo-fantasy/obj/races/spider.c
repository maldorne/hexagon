...
{
  return _LANG_RACES_SPIDER_DESC;
}
...
{
  return _LANG_RACES_SPIDER_GENDER_STRING;
}
...
mixed obtain_location()
{
  ...
  switch (random(20)) 
  {
    ...
    case 11..20: mult = 1.0; name = _LANG_RACES_LOCATIONS_ANIMAL_LEG; break;
  }

  return ({ mult, name, _LANG_RACES_SPIDER_BODY });
}
