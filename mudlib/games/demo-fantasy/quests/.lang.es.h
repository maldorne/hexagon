...
#define _LANG_QUEST_WASPS_TITLE "Las avispas y la caza"
#define _LANG_QUEST_WASPS_DESC "Unos enjambres de avispas han anidado junto a las " + \
      "sendas del bosque y están espantando a los animales. Los cazadores llevan " + \
      "semanas volviendo con las manos vacías, y en la taberna se nota. Acaba con " + \
...
#define _LANG_QUEST_NEWS_DESC "El viejo montaraz fue quien avisó de lo de las avispas, " + \
