...
void setup()
{
  set_name(_LANG_ZOMBIE_NAME);
  set_short(capitalize(_LANG_ZOMBIE_NAME));
  
  set_main_plural(capitalize(pluralize(_LANG_ZOMBIE_NAME)));
  add_plural(pluralize(_LANG_ZOMBIE_NAME));

  set_long(_LANG_ZOMBIE_DESC);
