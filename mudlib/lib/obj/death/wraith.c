...
void setup()
{
  set_name(_LANG_WRAITH_NAME);
  set_short(capitalize(_LANG_WRAITH_NAME));
  
  set_main_plural(capitalize(pluralize(_LANG_WRAITH_NAME)));
  add_plural(pluralize(_LANG_WRAITH_NAME));

  set_long(_LANG_WRAITH_DESC);
