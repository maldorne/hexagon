...
#define _LANG_TORCH_AS_NEW "Está como nueva.\n"
#define _LANG_TORCH_BURNT_OUT "Está completamente quemada.\n"
#define _LANG_TORCH_LEFT "Aún le queda un " + percentage + "% de uso.\n"
#define _LANG_TORCH_LIT " (%^YELLOW%^encendida%^RESET%^)"
#define _LANG_TORCH_LIT_PLURAL " (%^YELLOW%^encendidas%^RESET%^)"

#define _LANG_TORCH_VERBS_LIGHT ({ "encender" })
#define _LANG_TORCH_VERBS_EXTINGUISH ({ "apagar" })

#define _LANG_TORCH_WHAT "¿" + capitalize(query_verb()) + " el qué?\n"
#define _LANG_TORCH_HOLD_FIRST "Tienes que sostener la antorcha primero.\n"
#define _LANG_TORCH_ALREADY_LIT "La antorcha ya está encendida.\n"
#define _LANG_TORCH_ALREADY_OUT "La antorcha ya está apagada.\n"

#define _LANG_TORCH_YOU_LIGHT "%^YELLOW%^Enciendes la antorcha.%^RESET%^\n"
#define _LANG_TORCH_SOMEBODY_LIGHTS "%^YELLOW%^" + who->query_cap_name() + \
      " enciende una antorcha.%^RESET%^\n"
#define _LANG_TORCH_YOU_EXTINGUISH "Apagas la antorcha.\n"
