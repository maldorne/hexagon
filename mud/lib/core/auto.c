...
//     }
//   } else {
//     CHECKARG(typeof(obj) == T_OBJECT, 1, "destruct");
//     if (!this_object()) {
//       return FALSE;
//     }
//   }
...
//   if ((sscanf(oname, "/lib/core/%*s") != 0 && !lib && !KERNEL()) ||
...
//   if ((sscanf(path, "/lib/core/%*s") != 0 && !KERNEL()) ||
//     (creator != "system" &&
 ...
 */
// static void global_event(string name, mixed args...)
// {
//   object *objlist;
//   string *names;
//   int i, sz;
...
/*
 * NAME:    global_event_except()
 * DESCRIPTION:    broadcast an event, except to certain objects
 */
// static void global_event_except(string name, object *exclude, mixed args...)
// {
//   object *objlist;
//   string *names;
//   int i, sz;
...
//     sscanf(to, "/lib/core/%*s") != 0 ||
//     sscanf(from + "/", "/include/core/%*s") != 0 || from == "/include" ||
//     sscanf(to, "/include/core/%*s") != 0 ||
//     (creator != "system" &&
