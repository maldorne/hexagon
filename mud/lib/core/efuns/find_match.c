 ...
 *
 * Comprobaciones sobre it, him, her, them, eliminadas, Folken 4/03
 * El flag hidden tambien ignora programadores en invis, Folken 2/06
 * Tambien ignora los objetos con query_hidden_object (puertas)
 */
...
// Funciones de busqueda de objetivos utilizadas originalmente en 
...
// Sistema mas simple de find_match, para utilizar en las tiendas, Folken 04/2009
mixed simple_find_match(string str, mixed ob, varargs int no_hidden)
{
    object * list;
    string * id_list;
...
// A partir de aqui viene un intento de reescritura para un nuevo find_match que 
// nunca llego a funcionar, dejo el codigo comentado por si algun dia me da por ahi...
//  Folken 05/2009
